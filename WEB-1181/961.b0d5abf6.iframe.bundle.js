...
`,IconBox=(0,styled.Ay)("button")`
  ...
  > svg[data-testid='ClearIcon']:hover {
    background-color: ${colors.T.web.hover};
    border-radius: ${shippoTheme.A.spacing(1)};
  }
...
//# sourceMappingURL=961.b0d5abf6.iframe.bundle.js.map